...
byte outputEnablePin = 3;   // PWM - brightness control
byte dataPin = 4;           // digital - shift register data
byte latchPin = 5;          // PWM - shift register latch
byte clockPin = 6;          // PWM - shift register clock
byte raspberryPiPin = 7;    // PWM - read info from Pi
